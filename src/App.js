...
const particlesOptions = {
  ...
  // commented out lines below would add particles on every click
  interactivity: {
    detect_on: "window",
    events: {
      onhover: {
...
// this will calculate
  ...
  onPictureSubmit = () => {
    this.setState({imageUrl: this.state.input})
      fetch('https://hidden-spire-02638.herokuapp.com/imageurl', {
        method:  'post',
      ...
      .then(response => {
        if (response) {
          fetch('https://hidden-spire-02638.herokuapp.com/image', {
            method:  'put',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
